...
<head>
    ...
    <link href="{{ asset('assets/plugins/jvectormap/jquery-jvectormap-2.0.3.min.css') }}" rel="stylesheet">

    <link href="{{ asset('assets/css/main.css') }}" rel="stylesheet">
    <link href="{{ asset('assets/css/color_skins.css') }}" rel="stylesheet">
                    ...
                    <div class="body">
                        <ul class="messages list-unstyled">
                            <li>
                                <a href="javascript:void(0);">
                                    <div class="media">
                                        <img class="media-object rounded-circle" src="{{ asset('assets/images/xs/avatar1.jpg') }}"
                                            alt="">
                            ...
                            <li>
                                <a href="javascript:void(0);">
                                    <div class="media">
                                        <img class="media-object rounded-circle" src="{{ asset('assets/images/xs/avatar2.jpg') }}"
                                            alt="">
                                        <div class="media-body">
                            ...
                            <li>
                                <a href="javascript:void(0);">
                                    <div class="media">
                                        <img class="media-object rounded-circle" src="{{ asset('assets/images/xs/avatar3.jpg') }}"
                                            alt="">
                                        <div class="media-body">
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li><a href="javascript:void(0);" class="menu-toggle"><i
                                class="zmdi zmdi-apps"></i><span>App</span>
                    ...
                    <li><a href="javascript:void(0);" class="menu-toggle"><i
                                class="zmdi zmdi-grid"></i><span>Tables</span> <span
                                class="badge badge-info float-right">6</span></a>
                        <ul class="ml-menu">
                    ...
                    <li><a href="javascript:void(0);" class="menu-toggle"><i
                                class="zmdi zmdi-chart"></i><span>Charts</span> <span
                                class="badge badge-default float-right">6</span></a>
                        <ul class="ml-menu">
