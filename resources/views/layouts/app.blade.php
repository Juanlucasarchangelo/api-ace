...
<head>
    ...
    <title>{{ config('app.name', 'Alpino') }}</title>
    ...
    @stack('styles') {{-- Para estilos adicionais nas páginas --}}
</head>
...
<body class="theme-black">
    ...
    <!-- Scripts do Template -->
    <script src="{{ asset('assets/bundles/libscripts.bundle.js') }}"></script> <!-- Jquery Core Js -->
    ...
    <script src="{{ asset('assets/bundles/doughnut.bundle.js') }}"></script> <!-- Doughnut Chart Plugin Js -->

    <script src="{{ asset('assets/bundles/mainscripts.bundle.js') }}"></script>
    <script src="{{ asset('assets/js/pages/index.js') }}"></script>

    @stack('scripts') {{-- Para scripts adicionais nas páginas --}}
</body>
